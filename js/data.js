...
export const JENNY_SUPPLEMENTS = [
  {
    ...
    brand: 'Orthomol',
    dosageJenny: '1 Trinkfläschchen (20 ml) + 1 Kapsel täglich',
    dosageManufacturer: '1 Trinkfläschchen (20 ml) + 1 Kapsel täglich',
    unitsJenny: 2,
    unitsManufacturer: 2,
    timing: 'Morgens zum oder nach dem Frühstück',
    timeGroup: 'morning',
    icon: '☀️',
  ...
  },
  {
    ...
    unitsJenny: 1,
    unitsManufacturer: 1,
    timing: 'Morgens oder tagsüber mit Wasser',
    timeGroup: 'morning',
    icon: '🍊',
    badge: '225 mg Depot-Vitamin C + Bioflavonoide',
  ...
  },
  {
    ...
    dosageJenny: '1 Softgel-Kapsel täglich',
    dosageManufacturer: '1 Softgel-Kapsel täglich',
    unitsJenny: 1,
    unitsManufacturer: 1,
    timing: 'Mittags / Morgens zur Mahlzeit',
    timeGroup: 'noon',
    icon: '💧',
    badge: '640 mg Algen-Omega-3 (Triglycerid)',
  ...
  },
  {
    ...
    brand: 'Zinzino',
    dosageJenny: '1 Softgel täglich (Jennys Art)',
    dosageManufacturer: '2 Softgels täglich (Hersteller-Empfehlung)',
    unitsJenny: 1,
    unitsManufacturer: 2,
    timing: 'Mittags zur Hauptmahlzeit',
    timeGroup: 'noon',
    icon: '🌿',
    badge: 'Omega-3 + R.E.V.O.O Polyphenole',
  ...
  },
  {
    ...
    brand: 'Sunday Natural',
    dosageJenny: '1 Kapsel täglich (500 mg)',
    dosageManufacturer: '2 Kapseln täglich (1.000 mg)',
    unitsJenny: 1,
    unitsManufacturer: 2,
    timing: 'Nachmittags oder Abends',
    timeGroup: 'evening',
    icon: '🧘‍♀️',
    badge: 'KSM-66® Vollspektrum-Wurzelextrakt',
  ...
  },
  {
    ...
    brand: 'Sunday Natural',
    dosageJenny: '1 Kapsel täglich (500 mg)',
    dosageManufacturer: '1 Kapsel täglich (500 mg)',
    unitsJenny: 1,
    unitsManufacturer: 1,
    timing: 'Morgens oder Abends mit Wasser',
    timeGroup: 'evening',
    icon: '🍄',
    badge: '500 mg (30% Polysaccharide)',
  ...
  },
  {
    ...
    unitsJenny: 1,
    unitsManufacturer: 1,
    timing: 'Morgens zum Frühstück / Tee',
    timeGroup: 'morning',
    icon: '🌲',
    badge: '500 mg (20% Beta-Glucan)',
  ...
  },
  {
    ...
    brand: 'Sports & Health',
    dosageJenny: '3 Kapseln täglich (400 mg elementar)',
    dosageManufacturer: '3 Kapseln täglich (400 mg elementar)',
    unitsJenny: 3,
    unitsManufacturer: 3,
    timing: 'Abends vor dem Schlafen',
    timeGroup: 'evening',
    icon: '🌙',
    badge: '400 mg elementares Magnesium (Chelat)',
